  ...
  return (
    <div className="min-h-screen bg-[#0a1628] text-white relative overflow-hidden">
      ...
      <div className="absolute top-24 left-6 right-6 md:top-32 md:left-16 md:right-16 z-10 animate-fade-in flex flex-col items-center" style={{ animationDelay: '250ms', transform: 'translateY(30px)' }}>
        ...
        <p className="text-lg md:text-xl lg:text-xl font-normal text-slate-100 font-open-sauce leading-relaxed max-w-4xl text-center mb-2">
          {content.subtitle}
        </p>
      </div>
      ...
      <div className="absolute bottom-6 right-6 md:bottom-12 md:right-16 animate-fade-in" style={{ animationDelay: '450ms' }}>
        <button 
          onClick={() => {
            console.log('RagPipelineExplained button clicked');
            handleSubmit();
          }}
